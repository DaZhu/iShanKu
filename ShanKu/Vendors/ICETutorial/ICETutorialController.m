...
//    [self.rightButton setBackgroundColor:[UIColor darkGrayColor]];
    [self.rightButton setImage:[UIImage imageNamed:@"entergame_btn"] forState:UIControlStateNormal];
...
//    [constraints addObject:@"V:[_leftButton(==36)]-20-|"];
    ...
    [constraints addObject:@"H:|-20-[_leftButton(==_rightButton)]-20-[_rightButton(>=130)]-90-|"];
