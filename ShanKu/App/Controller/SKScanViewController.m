...
@interface SKScanViewController ()
...
- (void)viewDidLoad
{
    ...
    scanButton.frame = CGRectMake(100, 430, 120, 40);
    ...
    labIntroudction.text=@"随手扫一扫，体验精品小游戏";
...
//    _preview.frame =CGRectMake(20,110,280,280);
    _preview.frame = CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height - 50);
...
//        NSLog(@"%@ -----||??",stringValue);
         ...
         TOWebViewController *webViewController = [[TOWebViewController alloc] initWithURL:[NSURL URLWithString:stringValue]];
